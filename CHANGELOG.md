...
- `summary.json` lên `1.5`: `bottomHunter.crashMode` bật theo cổng mới (acute hoặc sụt ≥8%/42 phiên) và note nói rõ đây là độ tin cậy thấp (`src/lib/summary.ts`, `docs/summary-json.md`).
